...
public class MathExtend {
     ...
     * @param v1
     * @param v2
     * @return 两个参数的商, 有余的话，无论如何都+1
     */

    public static int divideGetIntMore(double v1, double v2) {

        double d = divide(v1, v2);
        int i = 0;
     ...
     * @param v1
     * @param v2
     * @return 两个参数的商, 有余的话，无论如何都舍去
     */

    public static int divideGetIntLess(double v1, double v2) {
